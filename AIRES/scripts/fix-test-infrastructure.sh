#!/usr/bin/env bash
# Fix all StyleCop violations in AIRES Test Infrastructure
# Phase 1: Using directives and formatting

set -e

echo "=== AIRES Test Infrastructure Fix Script ==="
echo "Phase 1: Using directives and basic formatting"
echo ""

TEST_DIR="/mnt/d/Projects/CSharp/Day_Trading_Platform_Dragon/AIRES/tests/AIRES.TestInfrastructure"

# Fix TestCaptureLogger.cs
echo "Fixing TestCaptureLogger.cs..."
cat > "$TEST_DIR/TestCaptureLogger.cs" << 'EOF'
