...
namespace TradingPlatform.Screening.Models
{
    ...
    {
        private readonly ILogger<TradingCriteria> _logger; // Logger for TradingCriteria

        public ScreeningRequest(ILogger<TradingCriteria> logger) // Constructor injection for logger
        {
            _logger = logger;
